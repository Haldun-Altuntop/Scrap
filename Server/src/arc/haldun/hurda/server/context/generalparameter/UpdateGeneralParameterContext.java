...
public class UpdateGeneralParameterContext implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            boolean permitted = SessionManager.instance.has(requestJson.optString("session-id"));

            JSONObject responseJson = new JSONObject();
            responseJson.put("permitted", permitted);

            if (permitted) {
                GeneralParameter parameter = new GeneralParameter(requestJson.optJSONObject("general-parameter"));
                DatabaseManager.updateGeneralParameter(parameter);
            }
